...
total_cost = sum(rent_cost + utlities_cost + food_cost + transportation_cost + computer_cost)
print(total_cost)
...
if total_cost <= budget:
    print("You're total cost is {f.total_cost}")
else:
    print("You're over budget by {f.budget}": budget - total_cost)
...
if rent_cost > sum(utilities_cost + food_cost + transportation_cost)
